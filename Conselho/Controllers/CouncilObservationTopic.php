...
class CouncilObservationTopic extends Controller
{
    public function __construct()
    {
        parent::__construct(CouncilObservationTopicMapper::class);
    }
    ...
    private function has_conflict() : bool {
        ...
        if ($observation_topic_id = $this->input_int('observation_topic_id')) {
            $school_ids[] = $atlas->fetchRecord(ObservationTopicMapper::class, $observation_topic_id)->school_id;
        }
