...
class ObservationTopic extends Controller
{
    public function __construct()
    {
        parent::__construct(ObservationTopicMapper::class);
    }
    ...
    private function check_permission(int $id = null) : bool {
        ...
        return $this->has_permission('observation_topic', $school_id);
    }
    ...
    public function delete(int $id) : void {
        ...
        $blocking_dependencies = ['student_observations', 'council_observation_topics'];
