...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  FULLTEXT INDEX `user_search` (`name` ASC, `email` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `school` (
  ...
  FULLTEXT INDEX `school_search` (`name` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `subject` (
  ...
  FULLTEXT INDEX `subject_search` (`name` ASC),
...
CREATE TABLE IF NOT EXISTS `grade` (
  ...
  PRIMARY KEY (`id`),
  INDEX `school_id_idx` (`school_id` ASC),
  FULLTEXT INDEX `grade_search` (`name` ASC),
...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  PRIMARY KEY (`id`),
  INDEX `school_id_idx` (`school_id` ASC),
  FULLTEXT INDEX `student_search` (`name` ASC),
...
CREATE TABLE IF NOT EXISTS `topic` (
  ...
  FULLTEXT INDEX `topic_search` (`name` ASC),
...
CREATE TABLE IF NOT EXISTS `council` (
  ...
  PRIMARY KEY (`id`),
  INDEX `school_id_idx` (`school_id` ASC),
  FULLTEXT INDEX `council_search` (`name` ASC),
...
CREATE TABLE IF NOT EXISTS `grade_observation` (
  ...
  INDEX `subject_id_idx` (`subject_id` ASC),
  INDEX `user_id_idx` (`user_id` ASC),
  FULLTEXT INDEX `grade_observation_search` (`description` ASC),
...
CREATE TABLE IF NOT EXISTS `student_observation` (
  ...
  INDEX `subject_id_idx` (`subject_id` ASC),
  INDEX `user_id_idx` (`user_id` ASC),
  FULLTEXT INDEX `student_observation_search` (`description` ASC),
...
CREATE TABLE IF NOT EXISTS `medical_report` (
  ...
  PRIMARY KEY (`id`),
  INDEX `student_id_idx` (`student_id` ASC),
  FULLTEXT INDEX `medical_report_search` (`description` ASC),
